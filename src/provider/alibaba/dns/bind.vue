...
import { Dns } from "@/api/alibaba/typings"
...
export default class DnsBind extends Vue {
    ...
    public domainList: Dns.DescribeDomainsResponseBodyDomainsDomain[] = []
    ...
    async bindDomian(item: Dns.DescribeDomainsResponseBodyDomainsDomain) {
    ...
    public syncDomian(item: Dns.DescribeDomainsResponseBodyDomainsDomain) {
