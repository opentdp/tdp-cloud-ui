...
@Component
export default class PassportPassword extends Vue {
    ...
    public formSubmit(form: FormInstance | undefined) {
        form && form.validate(valid => {
            ...
            NaApi.passport.updatePassword(this.formModel)
        })
    }
}
</script>
                ...
                <el-card shadow="hover">
                    ...
                    <el-form ref="formRef" :model="formModel" :rules="formRules" label-width="80px">
                        ...
                        <el-form-item label="新密码" prop="NewPassword">
                            <el-input v-model="formModel.NewPassword" show-password />
                        </el-form-item>
                        <el-form-item label="确认密码" prop="NewPassword2">
                            <el-input v-model="formModel.NewPassword2" show-password />
                        </el-form-item>
                        <el-form-item>
